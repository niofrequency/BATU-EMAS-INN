  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      <a
        ...
        className="relative group flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-2xl shadow-[#25D366]/40 border-2 border-[#69e897] transition-all duration-300 hover:scale-110 active:scale-95"
      >
        ...
        <svg
          ...
          className="fill-white text-[#25D366] group-hover:scale-110 transition-transform"
        >
          <path
